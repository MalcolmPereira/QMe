...
CREATE TABLE IF NOT EXISTS ANSWER_REFERENCE_MEDIA (
  ...
  REF_MEDIA_LINK_URL TEXT NULL COMMENT 'http url for reference - will open in new window or invoke the browser on devices',
...
CREATE TABLE IF NOT EXISTS ANSWER_OPTION_MEDIA (
  ...
  OPTION_MEDIA_LINK_URL TEXT NULL COMMENT 'Reference external http url ', 
