...
CREATE  TABLE IF NOT EXISTS ANSWER_REFERENCE_MEDIA (
  ANSWER_REF_MEDIA_ID INT(11) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key explanation reference id' ,
  QUESTION_ID INT(11) NOT NULL COMMENT 'Explanation reference belongs to a question, a question explanation can have zero or more references' ,
  REF_MEDIA_TYPE VARCHAR(50) NOT NULL COMMENT 'Reference type mime type - images, videos etc' ,
  REF_MEDIA BLOB NULL DEFAULT NULL COMMENT 'Reference media can be stored and save from server' ,
...
CREATE  TABLE IF NOT EXISTS ANSWER_OPTION_MEDIA (
  OPTION_MEDIA_ID INT(11) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key option media' ,
  OPTION_ID INT(11) NOT NULL ,
  OPTION_MEDIA_TYPE VARCHAR(50) NOT NULL COMMENT 'Answer option type mime type - images, videos etc' ,
  OPTION_MEDIA BLOB NULL DEFAULT NULL COMMENT 'Media data which save and served from server' ,
...
CREATE  TABLE IF NOT EXISTS USER_QUIZ_GAME (
  ...
  CAT_ID INT(11) NOT NULL COMMENT 'Category for Quiz Game Mode' ,
