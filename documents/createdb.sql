...
-- Add Media Type Data
INSERT INTO MEDIA_TYPE(MEDIA_MIME_TYPE)
VALUES ("image/png");
...
INSERT INTO CATEGORY (CAT_NAME,CAT_PARENT_ID,CAT_CREATE_DATE,CAT_CREATE_USER,CAT_LIKES)
VALUES ('Music', '0', CURRENT_TIMESTAMP, 1, 0);
INSERT INTO CATEGORY (CAT_NAME,CAT_PARENT_ID,CAT_CREATE_DATE,CAT_CREATE_USER,CAT_LIKES)
VALUES ('Movies', '0', CURRENT_TIMESTAMP, 1, 0);
INSERT INTO CATEGORY (CAT_NAME,CAT_PARENT_ID,CAT_CREATE_DATE,CAT_CREATE_USER,CAT_LIKES)
VALUES ('Computer Science', '2', CURRENT_TIMESTAMP, 1, 0);
INSERT INTO CATEGORY (CAT_NAME,CAT_PARENT_ID,CAT_CREATE_DATE,CAT_CREATE_USER,CAT_LIKES)
VALUES ('Programming Languages', '6', CURRENT_TIMESTAMP, 1, 0);
INSERT INTO CATEGORY (CAT_NAME,CAT_PARENT_ID,CAT_CREATE_DATE,CAT_CREATE_USER,CAT_LIKES)
VALUES ('Java', '7', CURRENT_TIMESTAMP, 1, 0);
...
INSERT INTO ANSWER_REFERENCE_MEDIA (QUESTION_ID, MEDIA_TYPE_ID, REF_MEDIA) 
VALUES ('1', '1', load_file('/tmp/cube.png'));
