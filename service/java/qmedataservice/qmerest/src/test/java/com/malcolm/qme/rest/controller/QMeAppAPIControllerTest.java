...
public class QMeAppAPIControllerTest extends QMeControllerTest{
    ...
    public void testApi() throws Exception {
        ...
        mockMvc.perform(
                ...
                .andExpect(jsonPath("content[0].links[0].rel", is("Get_All_User_list")))
                ...
                .andExpect(jsonPath("content[0].links[4].rel", is("Get_User_by_name")))
                .andExpect(jsonPath("content[0].links[4].href", is("null/qme/user/search/{name}")))
                .andExpect(jsonPath("content[0].links[5].rel", is("Get_User_by_email")))
                .andExpect(jsonPath("content[0].links[5].href", is("null/qme/user/searchemail/{email}")))
                .andExpect(jsonPath("content[0].links[6].rel", is("Post_New_User")))
                .andExpect(jsonPath("content[0].links[6].href", is("null/qme/user/register")))
                .andExpect(jsonPath("content[0].links[7].rel", is("Post_Stage_New_User")))
                .andExpect(jsonPath("content[0].links[7].href", is("null/qme/user/stage")))
                ...
                .andExpect(jsonPath("content[0].links[11].href", is("null/qme/user/reset/forgotusername/{email}")))
                .andExpect(jsonPath("content[0].links[12].rel", is("Put_Forgot_User_Password")))
                .andExpect(jsonPath("content[0].links[12].href", is("null/qme/user/reset/forgotpassword/{email}")))
                .andExpect(jsonPath("content[0].links[13].rel", is("Put_Reset_User_Password")))
                .andExpect(jsonPath("content[0].links[13].href", is("null/qme/user/reset/resetpassword/{email}")))
        ;
    }
