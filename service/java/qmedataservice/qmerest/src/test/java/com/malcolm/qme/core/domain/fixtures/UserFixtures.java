...
public class UserFixtures {
    ...
    public static List<User> simpleUserList(){
        ...
        userList.add(
                new User(2L, "suser2", "spassword2", "Simple 2", "Simple User 2", "SimpleUser2@User.com", LocalDateTime.now(), LocalDateTime.now(), 2L)
        );
        userList.add(
                new User(3L, "suser3", "spassword3", "Simple 3", "Simple User 3", "SimpleUser3@User.com", LocalDateTime.now(), LocalDateTime.now(), 3L)
        );
        userList.add(
                new User(4L, "suser4", "spassword4", "Simple 4", "Simple User 4", "SimpleUser4@User.com", LocalDateTime.now(), LocalDateTime.now(), 4L)
        );
        userList.add(
