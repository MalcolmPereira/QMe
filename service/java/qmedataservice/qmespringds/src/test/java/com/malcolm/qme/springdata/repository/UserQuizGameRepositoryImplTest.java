...
public class UserQuizGameRepositoryImplTest {
	...
	public void testCRUD() {
		...
		UserQuizGame userQuizGameUpdate = new UserQuizGame(userQuizGame.getUserGameToken(),userQuizGame.getUserID(),userQuizGame.getCategoryID(),10,userQuizGame.getQuizStartDate(),new Date());
