...
public class QuizQuestionSpringDataRepositoryTest {
	...
	public void testCRUD(){
		...
		CategoryEntity categoryEntity = new CategoryEntity("QuizQuestionSpringDataRepositoryTest", 0L, new Date(), 1L);
	...
	public void testFindByQuizId(){
		...
		CategoryEntity categoryEntity = new CategoryEntity("QuizQuestionSpringDataRepositoryTestByQuiz", 0L, new Date(), 1L);
		categoryEntity = categorySpringDataRepository.save(categoryEntity);
		assertNotNull(categoryEntity);
		assertThat(categoryEntity.getCatId(), greaterThan(0L));
		final Long catID = categoryEntity.getCatId();
	...
	public void testFindByQuestionId(){
		...
		CategoryEntity categoryEntity = new CategoryEntity("QuizQuestionSpringDataRepositoryTestByQuestion", 0L, new Date(), 1L);
		categoryEntity = categorySpringDataRepository.save(categoryEntity);
		assertNotNull(categoryEntity);
		assertThat(categoryEntity.getCatId(), greaterThan(0L));
		final Long catID = categoryEntity.getCatId();
