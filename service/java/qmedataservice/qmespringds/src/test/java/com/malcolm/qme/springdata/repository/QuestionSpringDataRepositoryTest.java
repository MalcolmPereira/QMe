...
public class QuestionSpringDataRepositoryTest {
    ...
    public void testFindAll(){
        ...
        List<QuestionEntity> questionEntities = questionSpringDataRepository.findAll();
    ...
    public void testFindById(){
        assertNotNull(questionSpringDataRepository);
        QuestionEntity questionEntity = questionSpringDataRepository.findOne(1L);
    ...
    public void testFindByCatId(){
        ...
        QuestionEntity questionEntity = new QuestionEntity(catID,"QuestionSpringDataRepositoryTest Question","QuestionSpringDataRepositoryTest Answer",0L,new Date(),1L,new Date(),1L);
        questionEntity = questionSpringDataRepository.save(questionEntity);
        assertNotNull(questionEntity);
        assertThat(questionEntity.getQuestionId(), greaterThan(0L));
        Long question1ID = questionEntity.getQuestionId();

        questionEntity = new QuestionEntity(catID,"QuestionSpringDataRepositoryTest Question","QuestionSpringDataRepositoryTest Answer",0L,new Date(),1L,new Date(),1L);
        questionEntity = questionSpringDataRepository.save(questionEntity);
        assertNotNull(questionEntity);
        assertThat(questionEntity.getQuestionId(), greaterThan(0L));
        Long question2ID = questionEntity.getQuestionId();
        
        questionEntity = new QuestionEntity(catID,"QuestionSpringDataRepositoryTest Question","QuestionSpringDataRepositoryTest Answer",0L,new Date(),1L,new Date(),1L);
        questionEntity = questionSpringDataRepository.save(questionEntity);
        assertNotNull(questionEntity);
        assertThat(questionEntity.getQuestionId(), greaterThan(0L));
        Long question3ID = questionEntity.getQuestionId();
    ...
    public void testFindTop50ByOrderByQuestionLikes(){
        ...
        QuestionEntity questionEntity = new QuestionEntity(catID,"QuestionSpringDataRepositoryTest Question1","QuestionSpringDataRepositoryTest Answer",0L,new Date(),1L,new Date(),1L);
        questionEntity = questionSpringDataRepository.save(questionEntity);
        assertNotNull(questionEntity);
        assertThat(questionEntity.getQuestionId(), greaterThan(0L));
        Long question1ID = questionEntity.getQuestionId();
        ...
        questionEntity = new QuestionEntity(catID,"QuestionSpringDataRepositoryTest Question2","QuestionSpringDataRepositoryTest Answer",0L,new Date(),1L,new Date(),1L);
        questionEntity = questionSpringDataRepository.save(questionEntity);
        assertNotNull(questionEntity);
        assertThat(questionEntity.getQuestionId(), greaterThan(0L));
        Long question2ID = questionEntity.getQuestionId();
        ...
        questionEntity = new QuestionEntity(catID,"QuestionSpringDataRepositoryTest Question3","QuestionSpringDataRepositoryTest Answer",0L,new Date(),1L,new Date(),1L);
        questionEntity = questionSpringDataRepository.save(questionEntity);
        assertNotNull(questionEntity);
        assertThat(questionEntity.getQuestionId(), greaterThan(0L));
        Long question3ID = questionEntity.getQuestionId();
