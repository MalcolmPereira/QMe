...
public class UserQuizLikesSpringDataRepositoryTest {
	...
	public void testCRUD(){
		...
		UserEntity userEntity = new UserEntity("UserQuizLikesSpringDataRepositoryTest", "Test", "Test", "UserQuizLikesSpringDataRepositoryTest@test.com", "Test", new Date(), new Date());
		...
		CategoryEntity categoryEntity = new CategoryEntity("UserQuizLikesSpringDataRepositoryTest", 0L, new Date(), userID);
		...
		QuizEntity quizEntity = new QuizEntity(
				...
				0, new Date(), userID,new Date(), userID);
	...
	public void testFindByUserId(){
		...
		UserEntity userEntity = new UserEntity("UserQuizLikesSpringDataRepositoryTestByUserID", "Test", "Test", "UserQuizLikesSpringDataRepositoryTestByUserID@test.com", "Test", new Date(), new Date());
		userEntity = userSpringDataRepo.save(userEntity);
		assertNotNull(userEntity);
		assertThat(userEntity.getUserId(), greaterThan(0L));
		final Long userID = userEntity.getUserId();

		CategoryEntity categoryEntity = new CategoryEntity("UserQuizLikesSpringDataRepositoryTestByUserID", 0L, new Date(), userID);
		categoryEntity = categorySpringDataRepository.save(categoryEntity);
		assertNotNull(categoryEntity);
		assertThat(categoryEntity.getCatId(), greaterThan(0L));
		final Long catID = categoryEntity.getCatId();
	...
	public void testFindByQuizId(){
		...
		UserEntity userEntity = new UserEntity("UserQuizLikesSpringDataRepositoryTestByQuizID", "Test", "Test", "UserQuizLikesSpringDataRepositoryTestByQuizID@test.com", "Test", new Date(), new Date());
		userEntity = userSpringDataRepo.save(userEntity);
		assertNotNull(userEntity);
		assertThat(userEntity.getUserId(), greaterThan(0L));
		final Long userID = userEntity.getUserId();

		CategoryEntity categoryEntity = new CategoryEntity("UserQuizLikesSpringDataRepositoryTestByQuizID", 0L, new Date(), userID);
		categoryEntity = categorySpringDataRepository.save(categoryEntity);
		assertNotNull(categoryEntity);
		assertThat(categoryEntity.getCatId(), greaterThan(0L));
		final Long catID = categoryEntity.getCatId();
